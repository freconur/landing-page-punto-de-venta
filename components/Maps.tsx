...
const Maps = () => {
  return (
    <div   id="contact"className='w-full bg-contactanos'>
      <h3 className='text-3xl text-white font-semibold capitalize font-poppins text-center py-[30px]'>Ubicanos y Contactanos</h3>
      ...
      <div className='bg-contactanos w-full font-montserrat py-[20px]'>
        <div className='flex gap-2 text-lg text-white justify-center items-center'>
          <div className='text-center m-auto py-5'>
            ...
            <p>Nos encontramos a una cuadra de la avenida Tambopata con jiron conima Mz. i lote 2.</p>
          </div>
        </div>
